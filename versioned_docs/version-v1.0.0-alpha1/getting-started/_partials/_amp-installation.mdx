{/* Shared partial: Agent Manager installation (Phase 2).
     ...
     Props expected from parent:
       - props.version            — release version string (e.g. "1.0.0-alpha1", "0.12.0")
...
With this module, agents run sandboxed under the standard **runc** runtime. Optionally, individual environments can run agents under **gVisor** or **Kata Containers** for stronger isolation — these have hardware/OS requirements and need a dedicated node. See the [gVisor](../../administration/isolation-tiers/gvisor.mdx) and [Kata Containers](../../administration/isolation-tiers/kata.mdx) isolation tier guides.
:::

...
```bash
curl -fsSL https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-RC1/deployments/setup/install-gvisor.sh \
  | sudo bash
```
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-RC1/deployments/k8s/gvisor-runtimeclass.yaml
...
```bash
curl -fsSL https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-RC1/deployments/scripts/add-environment.sh \

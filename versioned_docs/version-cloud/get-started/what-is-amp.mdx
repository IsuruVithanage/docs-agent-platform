...
Sign up and start managing agents at [console.agent-manager.cloud.wso2.com](https://console.agent-manager.cloud.wso2.com/). See the [Sign Up guide](./on-cloud.mdx) to get started.

## Plans & Pricing

WSO2 Agent Manager is free to use during the current early access period. See [Plans & Pricing](./plans.mdx) for current limits and upcoming paid plan details.

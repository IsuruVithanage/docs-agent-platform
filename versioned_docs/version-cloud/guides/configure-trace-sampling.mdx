...
Environment variables apply to one environment at a time, so set them for each environment you want sampled; values for later environments are configured when you promote.

...
- **Ballerina**: No Start Command or Language Version to set. The platform builds and runs the project directly. See [Deploy the Ballerina Leave Assistant Sample](build-a-ballerina-agent.mdx) for a ready to deploy example.

...
| `agentManagerService.image.tag` | Container image tag. Defaults to the chart's appVersion when empty | string | `"1.0.0-rc3"` |
...
| `console.image.tag` | Container image tag. Defaults to the chart's appVersion when empty | string | `"1.0.0-rc3"` |
...
| `console.config.ampVersion` | Agent Manager release version — pins the deployment-script git tag (amp/vX.Y.Z). Placeholder is substituted with the real release version by the release pipeline (.github/scripts/update-helm-charts.sh); dev builds fall back to main. | string | `"1.0.0-rc3"` |
...
| `dbMigration.image.tag` | Container image tag. Defaults to the chart's appVersion when empty | string | `"1.0.0-rc3"` |
